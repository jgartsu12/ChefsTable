...
class PhlogEditor extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            editMode: false,
            position: '',
            apiUrl: 'https://www.john-gartsu-flask-api.com/api/v1/image',
            apiAction: 'post'
        };
    ...
    deleteImage(event) {
        ...
        axios
            .delete(
                `https://jgartsu12.pythonanywhere.com/phlogapi/phlog/${this.state.id}/delete/`,
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.phlogToEdit).length > 0) {
            ...
            this.setState({
                ...
                position: position || '',
                editMode: true,
                apiUrl: `https://jgartsu12.pythonanywhere.com/phlogapi/`,
                apiAction: 'patch'
            });
